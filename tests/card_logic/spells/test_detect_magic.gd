...
func test_detect_magic_allows_explore_for_magic_card_on_owners_turn():
	...
	assert_true(Contexts.current_resolvable is ExamineResolvable, "Should have examine resolvable")
	
	var resolvable = Contexts.current_resolvable as ExamineResolvable
	...
	var explore_resolvable = Contexts.current_resolvable as PlayerChoiceResolvable
...
func test_detect_magic_allows_shuffle_for_non_magic_card():
	...
	var shuffle_resolvable = Contexts.current_resolvable as PlayerChoiceResolvable
