...
func test_dire_badger_damage_on_combat_defeat():
	...
	assert_true(GameServices.contexts.current_resolvable is DamageResolvable, "Should have damage resolvable")
	
	var resolvable = GameServices.contexts.current_resolvable as DamageResolvable
...
func test_dire_badger_no_damage_on_skill_defeat():
	...
	assert_null(GameServices.contexts.check_context, "Check context should be cleared")
