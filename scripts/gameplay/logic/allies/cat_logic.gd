...
func get_available_card_actions(card: CardInstance) -> Array[StagedAction]:	
	...
	and _contexts.check_context.resolvable.card is CardInstance \
	and _contexts.check_context.resolvable.card.data.card_type == CardType.SPELL \
	...
	# Discard to explore.
	if _contexts.is_explore_possible \
	and card.owner == _contexts.turn_context.character:
