...
func on_execute() -> void:
	...
	_contexts.encounter_context.current_phase = EncounterPhase.AFTER_ACTING
	
	if _contexts.encounter_context.ignore_after_acting_powers: return
	
	var resolvable = _contexts.encounter_context.card.get_after_acting_resolvable()
	if resolvable:
